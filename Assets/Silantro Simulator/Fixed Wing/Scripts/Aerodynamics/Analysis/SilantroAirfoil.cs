...
public class SilantroAirfoil : ScriptableObject
{
	...
	public List<float> lift; public List<float> drag; public List<float> moment;
	public List<float> LD; public List<float> AC; public List<float> CP; public List<float> alphas;
	public AnimationCurve centerCurve; public AnimationCurve pressureCurve;
	public AnimationCurve CLαCurve;


	// ------------------------LIMITS
	public float maxCl; public float maxCd; public float maxClCd;
	public float stallAngle; public float aerodynamicCenter; public string ReynoldsNumber;
...
public class SilantroAirfoilEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		//if (foil.detailed) { GUILayout.Space(2f); EditorGUILayout.LabelField("Reynolds Number", foil.ReynoldsNumber.ToString()) }
	}
