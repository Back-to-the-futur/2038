...
public class PhantomBulb : MonoBehaviour
{
	//-----------------------------SELECTIBLES
...
[CustomEditor(typeof(PhantomBulb))]
public class PhantomLightEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		if (bulb.lightType == PhantomBulb.LightType.Navigation || bulb.lightType == PhantomBulb.LightType.Strobe)
		{
			GUILayout.Space(3f);
		...
		if (bulb.lightType != PhantomBulb.LightType.Landing)
		{
			GUILayout.Space(3f);
