...
public class PhantomPistonEngine : MonoBehaviour
{
    ...
    public void InitializeEngine()
    {
        ...
        if (allOk)
        {
            ...
            core.engineType = PhantomEngineCore.EngineType.Piston;
            core.piston = GetComponent<PhantomPistonEngine>();
            core.overspeedAllowance = 0.06f;
